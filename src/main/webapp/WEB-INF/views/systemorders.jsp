			...
			<div class="span10">
				...
				<div >
					...
					<form:form class="form-horizontal"
						action="${pageContext.request.contextPath}/systemorders"
						...
						<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									...
									<form:select path="createdBy.id">
										<form:option value="-1" label="--Please Select User" />
										<form:options items="${usersList}" itemValue="id"
											itemLabel="names" />
									</form:select>
									...
									<form:select path="symbol.id">
										<form:option value="-1" label="--Please Select Currency" />
										<form:options items="${symbolsList}" itemValue="id"
											itemLabel="code" />
									</form:select>
					...
					<table class="table table-striped">
						...
						<c:if test="${not empty listTradeOrders}">
							<c:forEach items="${listTradeOrders}" var="tradeOrder">
								<tr>
									<td><c:out
											value="${tradeOrder.orderType}" /></td>
									...
									<td><c:out value="${tradeOrder.total}" /></td>
									<td><c:out value="${tradeOrder.fee}" /></td>

									<td><fmt:formatDate value="${tradeOrder.created}"
											type="both" pattern="dd MMMM yyyy h:mm:ss" /></td>
									<td><fmt:formatDate value="${tradeOrder.created}"
											type="both" pattern="dd MMMM yyyy h:mm:ss" /></td>
									<td><c:out value="${tradeOrder.createdBy}" /></td>
									<td><fmt:formatDate value="${tradeOrder.updated}"
											type="both" pattern="dd MMMM yyyy h:mm:ss" /></td>
									<td><c:out value="${tradeOrder.updatedBy}" /></td>
						...
						<c:if test="${empty listTradeOrders}">
							<tr>
